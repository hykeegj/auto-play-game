...
return_button_img = cv2.imread('return_button.png', cv2.IMREAD_GRAYSCALE)         #회전버튼
return_block_img = cv2.imread('return_block.png', cv2.IMREAD_GRAYSCALE)           #회전트리거
...
up_button_center = pag.locateCenterOnScreen(up_button_img, grayscale=True, confidence=0.8)

# 회전버튼 이미지 센터 좌표값 받아오기
return_button_center = pag.locateCenterOnScreen(return_button_img, grayscale=True, confidence=0.8)
